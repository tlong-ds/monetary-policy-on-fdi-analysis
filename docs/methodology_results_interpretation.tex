...
\begin{equation}
    FDI_{it} = \beta_1 Monetary_{it} + \boldsymbol{\gamma}'\mathbf{X}_{it} + \alpha_i + \lambda_t + \varepsilon_{it},
\end{equation}
where:
\begin{itemize}
    \item \(FDI_{it}\) is foreign direct investment net inflows as a percentage of GDP for country \(i\) in year \(t\);
    \item \(Monetary_{it}\) is the selected monetary condition or liquidity proxy for country \(i\) in year \(t\) (e.g., broad money as a percentage of GDP, nominal deposit rate, real interest rate, or lending interest rate);
...
Model M4 substitutes the nominal deposit rate with the real interest rate to test whether inflation-adjusted borrowing costs have a stronger relationship with investment. The broad-money coefficient remains positive at 0.0986 (SE 0.0662), and the real interest rate is negative at \(-0.0911\) (SE 0.0977), but both remain statistically insignificant.
...
\midrule
Broad money (\% GDP) & 0.0670 & 0.0732 & 0.0565 & 0.0986 & 0.0497 \\
 & (0.0578) & (0.0786) & (0.0616) & (0.0662) & (0.0605) \\
Deposit interest rate (\%) &  & -0.2940 &  &  &  \\
 &  & (0.3102) &  &  &  \\
Deposit interest rate, lag 1 (\%) &  &  & -0.0241 &  &  \\
 &  &  & (0.4672) &  &  \\
Real interest rate (\%) &  &  &  & -0.0911 &  \\
 &  &  &  & (0.0977) &  \\
Lending interest rate (\%) &  &  &  &  & -0.9684*** \\
 &  &  &  &  & (0.3467) \\
Trade (\% GDP) & -0.0311 & -0.0381* & -0.0220 & -0.0379 & -0.0547** \\
 & (0.0213) & (0.0224) & (0.0292) & (0.0261) & (0.0221) \\
Inflation, GDP deflator (\%) & 0.0244 & 0.0357 & 0.1000* &  & 0.0323 \\
 & (0.0910) & (0.0936) & (0.0548) &  & (0.0788) \\
Log GDP per capita & -3.1347 & -3.5097 & 0.7934 & -3.4257 & -4.8413 \\
 & (3.6327) & (3.8685) & (3.0341) & (3.7277) & (3.9939) \\
Exchange-rate depreciation (\%) & 0.0130 & 0.0508 & -0.0007 & 0.0147 & 0.1147 \\
 & (0.0773) & (0.1012) & (0.1091) & (0.0726) & (0.0992) \\
\midrule
Observations & 112 & 96 & 91 & 96 & 96 \\
Countries used & 9 & 8 & 8 & 8 & 8 \\
Within \(R^2\) & -0.0114 & -0.0376 & 0.0168 & 0.0150 & 0.0021 \\
Slope-adjusted within \(R^2\) & -0.0591 & -0.1076 & -0.0534 & -0.0398 & -0.0651 \\
\bottomrule
\end{tabular}
}
\begin{tablenotes}[flushleft]
...
M4 & 0.015 & -0.167 & 10.71 & 0.000 & 0.345 \\
...
The interest-rate results are also mixed. The negative deposit-rate, lagged deposit-rate, and real-rate coefficients are consistent with the view that higher rates raise financing costs, which may be associated with lower FDI inflows, but these estimates are not statistically significant. The lending-rate coefficient is negative and statistically significant, which is the clearest cost-of-capital signal in the analysis. However, because Cambodia has zero non-missing lending-rate years and Lao PDR has only one, this result should be read as suggestive robustness evidence from a restricted sample rather than as the chapter's primary result. The significant lending-rate coefficient may be partly driven by the subset of countries with lending-rate data, not necessarily by a universally stronger lending-rate transmission channel.
...
The most defensible conclusion is that monetary and financial conditions in ASEAN-oriented economies show directionally plausible associations with FDI inflows, especially for lending rates, but the short unbalanced panel, proxy-specific missingness, weak fit, and lack of exogenous identification prevent strong causal or policy-effect claims.
...
5. \textbf{Diagnostic fragility:} The within-\(R^2\) values are close to zero or negative in the main models, and slope-adjusted within \(R^2\) is negative in all reported main models, indicating limited explanatory power. Model M5 displays the highest max VIF among the main models (22.63) and the only statistically significant Pesaran CD warning (\(p = 0.015\)), directly qualifying its significant lending-rate coefficient. These diagnostic concerns suggest that substantive claims should be modest, and coefficients should be interpreted with caution.
